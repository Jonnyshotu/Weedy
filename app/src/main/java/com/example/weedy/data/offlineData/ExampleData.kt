    ...
    fun loadExamplePlants(): List<Plant> {
        return listOf(
            Plant(
                ...
                watering = listOf(
                    Pair(56.0, LocalDate.now()), Pair(89489.0, LocalDate.now()), Pair(
                        4891.0,
                        LocalDate.now()
                    ), Pair(87900.0, LocalDate.now()), Pair(305250.0, LocalDate.now()), Pair(
                        5880.0,
                        LocalDate.now()
                    ), Pair(566660.0, LocalDate.now()), Pair(20.0, LocalDate.now()), Pair(
                        5600.0,
                        LocalDate.now()
                    ), Pair(590.0, LocalDate.now())
                )
            ),
            Plant(
                2,
